...
class AboutUsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Keep extendBodyBehindAppBar so the background shows under the status bar
      ...
      body: Background(
        child: SingleChildScrollView(
          padding: const EdgeInsets.only(
            top: 120, // Increased top padding so content starts below the AppBar
            left: 16,
            right: 16,
            bottom: 32,
          ),
          child: Column(
            ...
            children: [
              _buildSectionCard(
                ...
                backgroundColor: const Color(0xFF0b0857), 
              ...
              _buildSectionCard(
                ...
                backgroundColor: const Color(0xFF28b6f6), 
                textColor: Colors.white,
